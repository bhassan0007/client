...
type EKLib interface {
	...
	PrepareNewUserEKForPUK(ctx context.Context, merkleRoot MerkleRoot, pukSigning *NaclSigningKeyPair) (sig string, boxes []keybase1.UserEkBoxMetadata, newMetadata keybase1.UserEkMetadata, myBox *keybase1.UserEkBoxed, err error)
